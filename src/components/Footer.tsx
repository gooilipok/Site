      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          ...
          <p className="text-xs text-[#7f8c8d] leading-relaxed">
            Инженерная команда специалистов для решения студенческих и научно-исследовательских задач любой сложности. Соблюдение сроков, сдача под ключ и полная конфиденциальность.
          </p>
        </div>
